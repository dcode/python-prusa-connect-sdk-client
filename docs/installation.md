...
If you primarily want to manage your printers from the command line, we recommend using [pipx](https://pypa.github.io/pipx/) to install the application in an isolated environment.
...
The `cli` extra installs additional dependencies like `cyclopts` and `rich`. If you plan to build your own CLI tools using this SDK, you might want to include them:
