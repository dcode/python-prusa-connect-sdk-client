...
from prusa_connect.auth import PrusaAccessToken, PrusaIdentityToken, PrusaRefreshToken
...
def test_access_token_parsing():
    ...
    token = PrusaAccessToken(raw_token)
...
def test_refresh_token_parsing():
    ...
    token = PrusaRefreshToken(raw_token)
...
def test_identity_token_parsing():
    ...
    token = PrusaIdentityToken(raw_token)
