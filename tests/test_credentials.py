...
def mock_tokens():
    ...
    access_payload = {"jti": "1", "sub": 1, "exp": future.timestamp(), "sid": "s", "app": "a", "type": "access", "connect_id": "c"}
...
def test_credentials_expired(mock_tokens):
    ...
    mock_tokens["access_token"] = create_dummy_jwt({
        "jti": "1", "sub": 1, "exp": past.timestamp(),
        "sid": "s", "app": "a", "type": "access", "connect_id": "c"
    })
...
def test_refresh_flow(mock_tokens):
    ...
    with patch("requests.Session.post") as mock_post:
        ...
        new_access_payload = {"jti": "3", "sub": 1, "exp": new_future.timestamp(), "sid": "s", "app": "a", "type": "access", "connect_id": "c"}
